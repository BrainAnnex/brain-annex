...
def test_create_tree_from_dict_1(db):
    ...
    root_neo_id = NeoSchema.create_tree_from_dict(data, class_name="address", cache_old=cache_old, cache=cache)
    print(root_neo_id)
...
def test_create_tree_from_dict_2(db):
    ...
    # Set up the Schema
    NeoSchema.create_class_with_properties(class_name="person",
                                                      property_list=["name"])
    NeoSchema.create_class_with_properties(class_name="address",
                                                      property_list=["state", "city"])
    ...
    root_neo_id = NeoSchema.create_tree_from_dict(data, class_name="person", cache_old=cache_old, cache=cache)
    print(root_neo_id)
...
def test_create_tree_from_list_1(db):
    ...
    root_neo_id_list = NeoSchema.create_trees_from_list(data, class_name="address", cache_old=cache_old, cache=cache)
...
def test_create_data_nodes_from_python_data_1(db):
    ...
    NeoSchema.create_class_with_properties(class_name="my_class_1",
...
def test_create_data_nodes_from_python_data_3(db):
    ...
    NeoSchema.create_class_with_properties(class_name="Import Data",
                                                      property_list=["source", "date"])
    NeoSchema.create_class_with_properties(class_name="patient",
