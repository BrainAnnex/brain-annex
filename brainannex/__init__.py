...
from brainannex.intergraph_neo4j_4.intergraph import InterGraph      # CHANGE AS NEEDED!
#from brainannex.intergraph_neo4j_5.intergraph import InterGraph     # CHANGE AS NEEDED!
