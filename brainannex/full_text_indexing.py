...
class FullTextIndexing:
    ...
    def new_indexing(cls, internal_id :int, unique_words :Set[str], to_lower_case=True) -> None:
        ...
        indexer_id = GraphSchema.add_data_node_with_links(class_name ="Indexer",
                                                          links =[{"_internal_id": internal_id, "rel_name": "has_index",
                                                                   "rel_dir": "IN"}])
        '''
    ...
    def search_word(cls, word :str, all_properties=False,
        ...
        :return:        If all_properties is False,
                        ...
                        If all_properties is True,
                            ...
                            plus keys called 'internal_id' and '_node_labels'
                            EXAMPLE: [{'filename': 'My_Document.pdf', 'internal_id': 66, '_node_labels': ['Content Item']}]
        """
