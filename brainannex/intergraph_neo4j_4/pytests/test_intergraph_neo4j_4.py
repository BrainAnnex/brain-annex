...
import pytest
from brainannex.intergraph_neo4j_4.intergraph_neo4j_4 import InterGraph
...
def test_constructor():
    ...
    assert obj1.driver_version().startswith("4.4")     # This will match any minor version, such as "4.4.13"
