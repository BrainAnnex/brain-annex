...
Vue.component('vue-plugin-rs',
    {
         ...
         */
        {
            ...
            if (this.item_data.entity_id < 0)  {  // A negative URI is a convention to indicate a just-created Recordset
                this.edit_recordset();
                return;
            }
        ...
        methods: {
            ...
            */
            ...
            {
                console.log(`In save_new_record(), for Recordset with URI '${this.current_metadata.entity_id}'`);
            ...
            save_recordset_edit()
            {
                console.log(`In save_recordset_edit(), for Recordset with URI '${this.current_metadata.entity_id}'`);
                ...
                if (this.current_metadata.entity_id < 0) {    // A negative URI is a convention to indicate a just-created Recordset
                    ...
                    var post_obj = {uri: this.current_metadata.entity_id,
                                    class_name: this.item_data.class_name,
            ...
            // Callback function to wrap up the action of save_recordset_edit(() upon getting a response from the server
            {
                ...
                if (success)  {     // Server reported SUCCESS
                    ...
                    if (this.current_metadata.entity_id < 0)  {
                        ...
                        this.current_metadata.entity_id = server_payload;     // Update the temporary URI with the value assigned by the server
                    }
                    else
            ...
            */
            {
                console.log(`In get_fields(): attempting to retrieve field names of recordset with URI '${this.current_metadata.entity_id}'`);
            ...
            get_recordset(page)
            {
                ...
                //console.log(`In get_recordset(): attempting to retrieve page ${page} of recordset with URI '${this.current_metadata.entity_id}'`);
