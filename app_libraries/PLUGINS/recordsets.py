...
class Recordsets:
    ...
    def initialize_schema(cls) -> None:
        ...
        GraphSchema.create_namespace(name="recordset", prefix="rs-", suffix="")
        match_to = GraphSchema.db.match(labels="Schema Autoincrement", key_name="namespace", key_value="recordset")
