...
def test_update_content_item(db):
    ...
    result = GraphSchema.get_single_data_node_OLD(node_id="photo_1", id_key="entity_id", class_name="Photo")
    ...
    with pytest.raises(Exception):
        DataManager.update_content_item(entity_id="photo_1", class_name="I_DONT_EXIST",
